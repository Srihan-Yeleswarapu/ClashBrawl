...
- **iOS Build**: Selects Xcode 26.6 (with fallback to any Xcode 26.x), downloads the iOS platform, installs XcodeGen, generates `ClashBrawl.xcodeproj`, and builds it for the iPhone 15 simulator.
